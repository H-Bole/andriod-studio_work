    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        cb1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                //判断是否被选中，并弹出提示信息
                if (cb1.isChecked()) {
                    Toast.makeText(RegisterActivity.this, "你选择了" + cb1.getText(), Toast.LENGTH_SHORT).show();
                } else {
                    Toast.makeText(RegisterActivity.this, "你取消了" + cb1.getText(), Toast.LENGTH_SHORT).show();
                }
            }
        });
        ...
        cb2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (cb2.isChecked()) {
                    Toast.makeText(RegisterActivity.this, "你选择了" + cb2.getText(), Toast.LENGTH_SHORT).show();
                } else {
                    Toast.makeText(RegisterActivity.this, "你取消了" + cb2.getText(), Toast.LENGTH_SHORT).show();
                }
            }
        });
        ...
        cb3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (cb3.isChecked()) {
                    Toast.makeText(RegisterActivity.this, "你选择了" + cb3.getText(), Toast.LENGTH_SHORT).show();
                } else {
                    Toast.makeText(RegisterActivity.this, "你取消了" + cb3.getText(), Toast.LENGTH_SHORT).show();
                }
            }
        });
        ...
        cb4.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (cb4.isChecked()) {
                    Toast.makeText(RegisterActivity.this, "你选择了" + cb4.getText(), Toast.LENGTH_SHORT).show();
                } else {
                    Toast.makeText(RegisterActivity.this, "你取消了" + cb4.getText(), Toast.LENGTH_SHORT).show();
                }
            }
        });
